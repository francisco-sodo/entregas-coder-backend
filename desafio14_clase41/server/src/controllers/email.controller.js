...
const mailOptions = {
    ...
    to: config.gmailAccount, // todo - email del que solicito el cambio de password
    subject: 'Solicitud para cambiar password', 
    html: `<div>
                <h3> Usted ha solicitado cambiar su password</h3>
                <button>Nuevo Password</button>
           </div>`, 
    attachments: [] 
}
...
export const sendEmail = (req, res) => {
    try {
        transporter.sendMail(mailOptions, (error, info) => { // el objeto info tiene toda la data sobre el mail enviado
            ...
            //todo -  aca deberia hacer un res.render a la vista donde modificar el password
